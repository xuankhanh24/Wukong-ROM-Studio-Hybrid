...
Object.assign(translations.vi, {
  ...
  greetingMorning: "Chào buổi sáng, {name}! Khởi đầu ngày mới tràn đầy năng lượng nhé.",
  greetingMorning2: "Buổi sáng tốt lành, {name}! Sẵn sàng cho những bản ROM đỉnh cao hôm nay.",
  greetingAfternoon: "Buổi chiều hiệu quả nhé, {name}! Chúc công việc luôn suôn sẻ.",
  greetingAfternoon2: "Chào buổi chiều, {name}! Mong mọi pipeline của bạn luôn xanh mướt.",
  greetingEvening: "Chào buổi tối, {name}! Thư giãn và trải nghiệm bản build mới nhé.",
  greetingEvening2: "Buổi tối an lành, {name}! ROM mát máy mượt, thoải mái giải trí.",
  greetingNight: "Cày đêm giữ sức khỏe nhé, {name}! Wukong runner vẫn miệt mài hỗ trợ bạn.",
  greetingNight2: "Đêm muộn rồi, {name} ơi! Đặt lệnh build xong nhớ nghỉ ngơi sớm nhé.",
  greetingWish: "Chúc bạn có một bản build thật mượt mà, tối ưu pin và sóng khỏe.",
  greetingWishSmooth: "Chúc bản build của bạn tối ưu pin trâu, sóng khỏe, mượt mà từng cú vuốt! ⚡",
  greetingWishCool: "Máy mát mẻ, hiệu năng bung tỏa tối đa, không lo tụt pin hay drop fps! 🎮",
  greetingWishClean: "ROM sạch bóng bloatware, giải phóng RAM, giao diện thanh thoát nhẹ nhàng. ✨",
  greetingWishFlash: "Chúc bản ROM flash là lên ngay, zero lỗi, khởi động tức thì! 🚀",
  greetingWishCustom: "Cá nhân hóa theo chất riêng của bạn — chiếc điện thoại đúng nghĩa thuộc về bạn. 🛠️",
  greetingWishMagisk: "Tích hợp MOD chuẩn xác, vượt qua kiểm tra bảo mật và chạy mượt mọi ứng dụng.",
  greetingAllowance: "Còn {remaining} lượt build khả dụng · Đã hoàn thành {jobs} job",
  greetingUnlimited: "Tài khoản không giới hạn lượt build · Đã hoàn thành {jobs} job",
...
Object.assign(translations.en, {
  ...
  greetingMorning: "Good morning, {name}! Have an energetic and productive start.",
  greetingMorning2: "Bright morning, {name}! Ready for top-tier custom builds today.",
  greetingAfternoon: "Have a focused afternoon, {name}! Wishing you smooth progress.",
  greetingAfternoon2: "Good afternoon, {name}! May all your pipelines run green.",
  greetingEvening: "Good evening, {name}! Relax and enjoy your latest custom build.",
  greetingEvening2: "Peaceful evening, {name}! Cool thermals and silky-smooth experience.",
  greetingNight: "Late night dev session, {name}? Take care, Wukong runner has your back.",
  greetingNight2: "Late hours, {name}! Queue your build and get some good rest.",
  greetingWish: "Wishing you a beautifully smooth build, great battery life, and strong signal.",
  greetingWishSmooth: "Wishing you long battery life, strong reception, and silky-smooth 120Hz gestures! ⚡",
  greetingWishCool: "Sustained peak performance, cool thermals, and zero frame drops in games! 🎮",
  greetingWishClean: "Bloatware-free, freed RAM, and a clean interface tailored to your style. ✨",
  greetingWishFlash: "One-shot flash, zero errors, instant boot — pure perfection! 🚀",
  greetingWishCustom: "Customized to your exact taste — your phone, your ultimate rules. 🛠️",
  greetingWishMagisk: "Flawless module integration, fully passing integrity and banking app checks.",
  greetingAllowance: "{remaining} builds available · {jobs} jobs completed",
  greetingUnlimited: "Unlimited build allowance · {jobs} jobs completed",
