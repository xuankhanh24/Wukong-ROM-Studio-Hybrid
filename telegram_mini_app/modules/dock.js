...
function applyTheme(theme = state.theme, persist = false) {
  ...
  document.querySelector('meta[name="theme-color"]')?.setAttribute("content", resolved === "dark" ? "#111318" : "#fdfcff");
  ...
  try {
    runtime.TelegramApp?.setHeaderColor?.(resolved === "dark" ? "#111318" : "#fdfcff");
    runtime.TelegramApp?.setBackgroundColor?.(resolved === "dark" ? "#111318" : "#fdfcff");
  } catch (_) {}
}
