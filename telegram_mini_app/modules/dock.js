...
function applyTheme(theme = state.theme, persist = false) {
  ...
  document.querySelector('meta[name="theme-color"]')?.setAttribute("content", resolved === "dark" ? "#0c1013" : "#f3f1eb");
  ...
  try {
    runtime.TelegramApp?.setHeaderColor?.(resolved === "dark" ? "#0c1013" : "#f8f7f2");
    runtime.TelegramApp?.setBackgroundColor?.(resolved === "dark" ? "#0c1013" : "#f3f1eb");
  } catch (_) {}
}
